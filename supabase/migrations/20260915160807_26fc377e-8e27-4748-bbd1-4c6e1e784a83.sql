...
REVOKE ALL ON FUNCTION public.shares_active_ride(UUID, UUID) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.has_role(UUID, public.app_role) TO authenticated;
GRANT EXECUTE ON FUNCTION public.is_ride_participant(UUID, UUID) TO authenticated;
GRANT EXECUTE ON FUNCTION public.shares_active_ride(UUID, UUID) TO authenticated;